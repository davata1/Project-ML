...
st.title("Machine Leraning")
st.write("### Nama Kelompok")
st.write("##### San Sayidus Solatal A’la (200411100032)")
st.write("##### Dhafa Febriyan Wiranata   (200411100169)") 
st.write("##### Kelas : Machine Learning B ")
...
with implementation:
    with st.form("my_form"):
        ...
        model = st.checkbox('Decission Tree')
